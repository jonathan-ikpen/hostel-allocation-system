                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="../assets/images/logo-icon-nav.png" alt="homepage" class="dark-logo" width="40" />
                                <!-- Light Logo icon -->
                                <img src="../assets/images/logo-icon-nav.png" alt="homepage" class="light-logo" width="40" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
