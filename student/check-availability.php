<?php
    ...
    $stmt->close();
    if($count>0)
    echo "<span id='count-occupant' data-occupants='$count' style='color:red'>$count. occupants in the room already.</span>";
    else
        echo "<span style='color:red'>No Occupant in this room</span>";
    }
?>